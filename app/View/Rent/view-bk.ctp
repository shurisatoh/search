...
foreach ($imgFile as $index => $va) {
	if (!empty($data[$modelName][$va[0]])) {
		$imgNumber = $index; // ← index をそのまま番号として使う（0?11）
		$imgPath = '../img/rent/gazou/' . $data[$modelName]['id'] . '_' . $imgNumber . '.jpg';
		$imgTag = '<img src="' . $imgPath . '" width="100%" /><div class="imgtitle">' . $data[$modelName][$va[1]] . '</div>';
		$data[$modelName][$va[0]] = $imgTag;
	} else {
		$data[$modelName][$va[0]] = '';
	}
}
...
//--金額カンマ挿入+円追加処理
$nfArray = array('kyoueki_k','tyuusya_k');
foreach( $nfArray  as $va ){
	if(is_numeric($data[$modelName][$va])){
		$data[$modelName][$va] = number_format($data[$modelName][$va]).'Yen';
	}
}
$setubi ='';
$setubi_msc ='';
...
<table class="table_center w100"><tr>
	<td class="bkco">Address</td>
	<td colspan="3"><?php echo $address_en.$data[$modelName]['bu_zyuusyo2']; ?></td>
</tr></table>
<table class="table_center w50"><tr>
    <td class="bkco">Layout　㎡</td>
    <td><span class="pu"><?php echo $madori1Arr[$data[$modelName]['madori1']].
    $data[$modelName]['madori2']; ?></span>　<?php echo $data[$modelName]['heibei']; ?>㎡</td>
</tr></table>
<table class="table_center w50"><tr>
    <td class="bkco">Prop No</td>
    <td><?php echo $data[$modelName]['new'].'No.'.$data[$modelName]['id']; ?></td>
</tr></table>
<table class="table_center w50"><tr>
    <td class="bkco">Total floors</td>
    <td><?php echo $data[$modelName]['syozaikai'].'th floor／'.$data[$modelName]['syozaikai'].' Total floors'; ?></td>
</tr></table>
<table class="table_center w50"><tr>
...
<table class="table_center w50"><tr>
    <td class="bkco"><?php echo 'Deposit／Key Money'; ?></td>
    <td><?php echo $data[$modelName]['hosyou_k'].' Months／'.$data[$modelName]['kaiyaku_k'].' Months'; ?></td>
</tr></table>
<table class="table_center w50"><tr>
    <td class="bkco">Rent</td>
    <td><span class="pu"><?php echo $data[$modelName]['yatin_k']; ?></span> Yen</td>
</tr></table>
<table class="table_center w50"><tr>
...
<table class="table_center w50"><tr>
    <td class="bkco">Maintenance fee</td>
    <td><?php echo $data[$modelName]['kyoueki_k']; ?></td>
</tr></table>
<table class="table_center w50"><tr>
...
<table class="table_center w50"><tr>
    <td class="bkco">Car park fee</td>
    <td><?php echo $data[$modelName]['tyuusya_k']; ?></td>
</tr></table>
<table class="table_center w50"><tr>
    <td class="bkco">Balcony</td>
    <td><?php echo $barukoniiArr[$data[$modelName]['barukonii']].'　'.$mukiArr[$data[$modelName]['muki']].' Facing'; ?></td>
</tr></table>
<table class="table_center w50"><tr>
...
<table class="table_center w100"><tr>
    <td class="bkco">Other initial cost</td>
    <td colspan="3">
    <table align="center">
      <tr>
        <td align="left">
Agent fee 110% of a month rental including tax, Guarantor company fee 50%~120% of a month rental, Insurance for two years 20,000~yen, Lock changing fee 16,500~yen.
        </td>
      </tr>
    </table>
    </td>
  ...
  <tr>
    ...
    <table border="0" align="center" id="noborder">
      <tr>
        ...
        <a href="<?php echo $this->webroot.'Rent/contact?id='.$data[$modelName]['id']; ?>">
