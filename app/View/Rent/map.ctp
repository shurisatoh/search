...
echo '<script src="https://maps.googleapis.com/maps/api/js?key='.GOOGLEMAPAPIKEY.'&callback=initMap&language=en"></script>'."\n";
?>
<?php echo $table; ?>
<p class="page">
